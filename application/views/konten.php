<body>
	...
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="<?= base_url("") ?>/assets/img/logo.png" data-active-url="img/logo-active.png" alt=""></a>
			</div>
	...
	<script src="<?= base_url("") ?>/assets/js/typewriter.js"></script>
	<script src="<?= base_url("") ?>/assets/js/jquery.onepagenav.js"></script>
